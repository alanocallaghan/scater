...
test_that("margin summaries are correctly computed", {
    ...
    expect_equal(scater:::.rowSums(A.int, rows=5:1), rowSums(A.int[5:1,]))
    expect_equal(scater:::.rowAbove(A.int, rows=5:1), rowSums(A.int[5:1,] > 0))
    expect_equal(scater:::.rowAbove(A.int, rows=5:1, value=1), rowSums(A.int[5:1,] > 1))
    ...
    expect_equal(scater:::.colSums(A.int, cols=5:1), colSums(A.int[,5:1]))
    expect_equal(scater:::.colAbove(A.int, cols=5:1), colSums(A.int[,5:1] > 0))
    expect_equal(scater:::.colAbove(A.int, cols=5:1, value=1), colSums(A.int[,5:1] > 1))
...
test_that("row/column variances are correctly computed", {
    ...
    expect_equal(scater:::.rowVars(A.int, rows = 5:1), apply(A.int[5:1,], 1, var))
    ...
    expect_equal(scater:::.colVars(A.int, cols = 5:1), apply(A.int[,5:1], 2, var))
    ...
    expect_equal(scater:::.rowVars(A.dbl, rows = 5:1), apply(A.dbl[5:1,], 1, var))
    ...
    expect_equal(scater:::.colVars(A.dbl, cols = 5:1), apply(A.dbl[,5:1], 2, var))
    ...
    expect_equal(scater:::.rowVars(A.dgc, rows = 5:1), apply(A.dgc2[5:1,], 1, var))
    ...
    expect_equal(scater:::.colVars(A.dgc, cols = 5:1), apply(A.dgc2[,5:1], 2, var))
})
