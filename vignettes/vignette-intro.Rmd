...
* Wrappers to [_kallisto_](http://pachterlab.github.io/kallisto/) and [_Salmon_](https://combine-lab.github.io/salmon/) for rapid quantification of transcript abundance; 
...
`r Biocpkg("scater")` also provides wrapper functions to `kallisto` and `Salmon` for easy and extremely fast quantification of transcript abundance from within R.
