...
#' directories = directories, type = "kallisto")
#' 
#' ## for faster reading of results use the read_tsv function from the readr pkg
#' library(readr)
#' sce_example <- readTxResults(samples = names(directories), 
#' directories = directories, type = "kallisto", reader = read_tsv)
#' }
#' 
readTxResults <- function(samples = NULL, directories = NULL, 
    ...
    if ( !all(file.exists(files)) )
        stop("Some of the directories do not contain the expected abundance.tsv file!")
